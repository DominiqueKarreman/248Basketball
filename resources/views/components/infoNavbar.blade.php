...
<nav class="bg-white  bg-transparent border-gray-200 dark:bg-gray-900 {{ $class }}">
    <div class="flex w-full bg-transparent flex-wrap items-center justify-between sm:w-[90vw] mx-auto p-4">
        ...
        <div class="flex md:order-2">
            <button type="button"
                class="text-white bg-[#EDB12C] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('Login') }}</button>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-2 text-[2vh] pl-3 pr-4 text-gray-500 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#EDB12C] md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('Services') }}</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-[0.2vh] text-[2vh]  pl-3 pr-4 text-gray-500 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#EDB12C] md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('Contact') }}</a>
                </li>
            </ul>
        </div>
    </div>
