        ...
        <table class="w-full text-sm bg-zinc-700 text-left text-gray-500 dark:text-gray-400 ">
            ...
            <tbody>
                <tr class="bg-zinc-700 border-b border-zinc-800 dark:bg-gray-800 dark:border-gray-700">
                    <th scope="row"
                        class="py-4 px-6 font-medium text-white whitespace-nowrap dark:text-white align-top">
                        {{ $contact->name }}
                    </th>
                    <th scope="row"
                        class="py-4 px-6 font-medium text-white whitespace-nowrap dark:text-white align-top">
                    ...
                    <th scope="row" 
                        class="py-4 px-6 font-medium text-white dark:text-white whitespace-wrap">
