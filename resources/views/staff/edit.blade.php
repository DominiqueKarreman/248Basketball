<x-app-layout>
    ...
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg w-full sm:w-3/4 mx-auto mt-6 ">
        <form action="{{ route('staff.update', $staffMember->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
                ...
                <tbody>
                    ...
                    <tr class="bg-zinc-700 border-b border-t border-zinc-900 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th scope="row"
                            ...
                            <input type="text" name="name" id="naam" required value="{{$staffMember->name}}"
                        ...
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap dark:text-white">
                            <input type="text" name="role" id="rol" required value="{{$staffMember->role}}"
                                class="block w-full p-3 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </th>
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap dark:text-white">
                            <input type="text" name="email" id="email" required value="{{$staffMember->email}}"
                                class="block w-full p-3 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </th>
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap  dark:text-white">
                            <select required name="user_id" id="gebruiker" 
                                ...
                                @if($staffMember->user_id && $staffMember->user_id == $user->id)
                    ...
                    <tr class="bg-zinc-700  dark:bg-gray-800 border-b border-t border-zinc-900 dark:border-gray-700">
                        <th colspan="6" scope="row"
                            ...
                            <div class="imgdiv">
                                ...
                                <img src="/{{$staffMember->image}}" class="img_preview " id="img_preview" alt="asdasd">
                            </div>
                        </th>
                        ...
                        <th colspan="6" scope="row"
                            ...
                            <div class="imgdiv">
                                ...
                                {{-- <img src="" class="img_preview2 hidden" id="img_preview2" alt="asdasd"> --}}
                                 <video autoplay muted playsinline class="img_preview2" id="img_preview2" src="/{{$staffMember->video}}"></video>
                            </div>
                        </th>
                    ...
                    <tr class="bg-zinc-700 border-b border-t border-zinc-900 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap dark:text-white">
                            <input type="text" name="phone" id="number" required value="{{$staffMember->phone}}"
                                class="block w-full p-3 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </th>
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap dark:text-white">
                            <input type="text" name="instagram" id="instagram" placeholder="https://www.instagram.com/..." value="{{$staffMember->instagram}}"
                                class="block w-full p-3 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </th>
                        ...
                        <th scope="row"
                            ...
                            placeholder="https://www.linkedin.com/in..." value="{{$staffMember->linkedin}}"
                                class="block w-full p-3 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </th>
                        <th scope="row"
                            class="py-4 px-6 font-medium text-[#EDB12C] whitespace-nowrap dark:text-white">
                            <input type="text" name="facebook" id="facebook" value="{{$staffMember->facebook}}"
                    ...
                    <tr class="bg-zinc-700 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <th colspan="6" scope="row"
                            ...
                            <textarea type="text" name="beschrijving" id="beschrijving" required placeholder="Beschrijving"
                                class="block w-full p-2 text-[#EDB12C] border border-black rounded-lg bg-zinc-800 placeholder-[#EDB12C] sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{$staffMember->description}}"</textarea>
                        </th>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="overflow-x-auto relative  shadow-md sm:rounded-lg w-full sm:w-3/4 mx-auto my-6 ">
        <button id="submit" type="submit"
            class="text-white bg-blue-700 m-auto hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-200 focus:outline-none dark:focus:ring-blue-800">Edit Medewerker</button>
