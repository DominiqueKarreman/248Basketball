...
<body class="bg-black flex flex-col place-items-center h-full w-full">
    ...
    <div class="flex flex-row bottom-[10vh] absolute gap-[18vh]">
        ...
        <div class="text-white">asdfasdfasfdasdfasdfasdfasdfasdfsadfasdfasfasdfasdf</div>
        <div class="text-white">
            <h1>Socials
            </h1>
            <svg width="10vh" height="10vh" viewBox="0 0 176 176" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M88 42.7969C63.0438 42.7969 42.7969 63.0438 42.7969 88C42.7969 112.956 63.0438 133.203 88 133.203C112.956 133.203 133.203 112.956 133.203 88C133.203 63.0438 112.956 42.7969 88 42.7969ZM88 117.322C71.8094 117.322 58.6781 104.191 58.6781 88C58.6781 71.8094 71.8094 58.6781 88 58.6781C104.191 58.6781 117.322 71.8094 117.322 88C117.322 104.191 104.191 117.322 88 117.322Z" fill="white"/>
                <path d="M145.544 41.0092C145.544 46.8529 140.8 51.5623 134.991 51.5623C129.147 51.5623 124.438 46.8186 124.438 41.0092C124.438 35.1654 129.181 30.4561 134.991 30.4561C140.8 30.4561 145.544 35.1998 145.544 41.0092Z" fill="white"/>
                </g>
                <defs>
